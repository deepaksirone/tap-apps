...
if (minAfterSunrise >= sunriseDelay)
{
    ...
    msg = 'At least one half-hour since Sunrise, activating the Lutron Scene';
...
else
{
    ...
    msg = 'Not at least 30 minutes after Sunrise, NOT activating the Lutron Scene' + '(' + minAfterSunrise + ')'   + '(' + sunriseDelay + ')';
    IfNotifications.sendNotification.setMessage(msg);
